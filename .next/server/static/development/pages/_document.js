...
class Mydocument extends next_document__WEBPACK_IMPORTED_MODULE_1___default.a {
  static async getInitialProps(ctx) {
    ...
    try {
      ...
      let initProps = await next_document__WEBPACK_IMPORTED_MODULE_1___default.a.getInitialProps(ctx);
      return _objectSpread({}, initProps, {
        styles: __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, initProps.styles, sheet.getStyleElement())
      });
    } finally {
      sheet.seal();
    }
  ...
  render() {
    return __jsx(next_document__WEBPACK_IMPORTED_MODULE_1__["Html"], null, __jsx(next_document__WEBPACK_IMPORTED_MODULE_1__["Head"], null, __jsx("title", null, "Marihub"), __jsx("link", {
      rel: "shortcut icon",
      href: "/static/web-icon.jpg"
    })), __jsx("bod", null, __jsx(next_document__WEBPACK_IMPORTED_MODULE_1__["Main"], null), __jsx(next_document__WEBPACK_IMPORTED_MODULE_1__["NextScript"], null)));
  }
