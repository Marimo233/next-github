...
function SearchUser(_ref) {
  ...
  var lastFetchIdRef = Object(react__WEBPACK_IMPORTED_MODULE_2__["useRef"])(0);
  var handleSearch = Object(react__WEBPACK_IMPORTED_MODULE_2__["useCallback"])(Object(lodash__WEBPACK_IMPORTED_MODULE_3__["debounce"])(function (value) {
  ...
  return __jsx(antd_lib_select__WEBPACK_IMPORTED_MODULE_1___default.a, (_jsx = {
    value: value,
    filterOption: false,
    showSearch: true
    ...
    width: '100%'
  }), Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_jsx, "onSearch", handleSearch), Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_jsx, "onChange", handleChange), _jsx), data.map(function (item) {
    return __jsx(Option, {
      value: item.value,
      key: item.key
    }, item.text);
...
//# sourceMappingURL=issues.js.a6c5a691d27093a4e211.hot-update.js.map